...
def connect_tcp_socket() -> sqlalchemy.engine.base.Engine:
    ...
    db_user = config['env_variables']['DB_USER']
    db_pass = config['env_variables']['DB_PASS']
    db_name = os.environ.get('DB_NAME', config['env_variables']['DB_NAME'])
    db_port = os.environ.get('DB_PORT', config['env_variables']['DB_PORT'])
    db_host = os.environ.get('INSTANCE_HOST', config['env_variables']['INSTANCE_HOST'])
